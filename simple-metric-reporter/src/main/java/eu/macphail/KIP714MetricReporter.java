...
public class KIP714MetricReporter implements MetricsReporter, ClientTelemetry {
    ...
    public void init(List<KafkaMetric> metrics) {
        log.info("Initializing the KIP-714 metric reporter");
    }
    ...
    public void configure(Map<String, ?> configs) {
        ...
        log.info("KIP-714 metrics reporter initialized with endpoint {} (timeout: {})", otlpMetricsEndpoint, otlpMetricsConnectTimeout);
